"""added player, team, tournament, user_team

Revision ID: 3c5e45f9135a
Revises: 
Create Date: 2022-07-23 12:38:45.709019
...
def upgrade() -> None:
    ...
    sa.Column('team_points_row', sa.Integer(), nullable=False),
    sa.Column('tournament_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['tournament_id'], ['tournament.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('discord_role_id'),
    sa.UniqueConstraint('name'),
    sa.UniqueConstraint('team_points_row')
    )
    op.create_table('player',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('creation_timestamp', sa.TIMESTAMP(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('points_row', sa.Integer(), nullable=False),
    sa.Column('bidding_row', sa.Integer(), nullable=False),
    sa.Column('team_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['team_id'], ['team.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('bidding_row'),
    sa.UniqueConstraint('name'),
    sa.UniqueConstraint('points_row')
    )
